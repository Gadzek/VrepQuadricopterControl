...
public class simpleTest
{
	public static void main(String[] args)
	{
		...
		if (clientID!=-1)
		{
			...
			IntW droneHandle = new IntW(0);
			vrep.simxGetObjectHandle(clientID, "Quadricopter_target", targetHandle, vrep.simx_opmode_oneshot_wait);
			vrep.simxGetObjectHandle(clientID, "Quadricopter_base", droneHandle, vrep.simx_opmode_oneshot_wait);
			
			FloatWA dronePosition = new FloatWA(3);
			System.out.println(dronePosition.getLength());
			vrep.simxGetObjectPosition(clientID, droneHandle.getValue(), -1, dronePosition, vrep.simx_opmode_streaming);
			
			//dronePosition.
			//vrep.simxSetObjectPosition(clientID, targetHandle.getValue(), -1, dronePosition, vrep.simx_opmode_oneshot);
